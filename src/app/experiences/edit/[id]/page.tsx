...
export default function ExperiencesEditPage() {
  ...
  const { mutate: updateExperience, isLoading: isUpdating } = useUpdate();
  ...
  useEffect(() => {
    if (data?.data) {
      setFormData({
        ...
        category: data.data.category || "BUILDING",
  ...
  return (
    <Layout>
      <div className="p-6 max-w-2xl">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Experience</h1>
